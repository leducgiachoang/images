...
jQuery(document).ready(function () {
        jQuery('#button_search').click(function () {
                ...
                fetch("https://api.pexels.com/v1/search/?page=1&per_page=80&query=" + value_key, {
                        ...
                        document.getElementById('button_next').setAttribute('link-next', link_next)
                })
        });
        $('#button_next').click(function () {
                var link_next = document.getElementById('button_next').getAttribute('link-next');
        ...
        fetch("https://api.pexels.com/v1/search/?page=1&per_page=80&query=vietnam", {
                headers: {
                        Authorization: "563492ad6f917000010000011da97604116d4926aa3bd66d8e472c57"
                }
        }).then(resp => {
